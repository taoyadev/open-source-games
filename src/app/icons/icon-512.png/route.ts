    ...
    React.createElement(
      "div",
      {
        style: {
          ...
          background:
            "radial-gradient(520px 520px at 30% 30%, rgba(99,102,241,0.5) 0%, rgba(99,102,241,0) 60%), radial-gradient(520px 520px at 70% 40%, rgba(219,39,119,0.5) 0%, rgba(219,39,119,0) 60%), #09090b",
          borderRadius: 96,
